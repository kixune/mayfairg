...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modalHelpers__ = __webpack_require__(4);
__webpack_require__(3);


__WEBPACK_IMPORTED_MODULE_0__modalHelpers__["a" /* default */].init();
  ...
  */
	...
	init: function init() {
		...
		$('.modal').on('show.bs.modal', function () {
			...
			window.scrollTo(0, _this.currentPosition);
		});

		// Reposition when the window is resized
		$(window).on('resize', function () {
			$('.modal:visible').each(_this.reposition);
		});
	}
});
